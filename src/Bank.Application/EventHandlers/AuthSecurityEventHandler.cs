...
/// </summary>
public class AuthSecurityEventHandler : INotificationHandler<SecurityEvent>
{
    private readonly IAuditLogService _auditLogService;
    private readonly ILogger<AuthSecurityEventHandler> _logger;

    public AuthSecurityEventHandler(
        IAuditLogService auditLogService,
        ILogger<AuthSecurityEventHandler> logger)
    {
