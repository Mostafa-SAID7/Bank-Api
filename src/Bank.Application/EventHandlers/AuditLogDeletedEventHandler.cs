...
/// </summary>
public class AuditLogDeletedEventHandler : INotificationHandler<EntityDeletedEvent>
{
    private readonly IAuditLogService _auditLogService;
    private readonly ILogger<AuditLogDeletedEventHandler> _logger;

    public AuditLogDeletedEventHandler(
        IAuditLogService auditLogService,
        ILogger<AuditLogDeletedEventHandler> logger)
    {
